...
public class Back4AppService {
    ...
    // 5a. Método de Upload que aceita APENAS o arquivo (Retorna JsonObject para os cadastros)
    ...
    // 5b. Método de Upload que aceita Arquivo E uma String (Exatamente o que seus controladores de cadastro estão enviando!)
